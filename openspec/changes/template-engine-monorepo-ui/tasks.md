...
- [ ] 4.1 Initialize React/Vite development scaffolding inside `apps/web`
- [ ] 4.2 Configure Vitest (or Jest), ESLint, and Prettier rules in the frontend workspace matching existing code-standards
...
- [ ] 5.1 Create unit test `useTemplateParser.test.tsx` targeting the central custom hook
- [ ] 5.2 Implement RED state for initial hook state (template, variables table, result, isParsing, error)
- [ ] 5.3 Implement atomic state mutations for adding/editing/removing variables (Option C) and template updates, verifying in GREEN
